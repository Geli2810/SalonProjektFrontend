  ...
  return (
    <div style={{ fontFamily: "'Segoe UI', Arial, sans-serif", background: "#080c14", color: "#e8edf5", minHeight: "100vh" }}>
      ...
      <div style={{ maxWidth: 1000, margin: "0 auto", padding: "40px" }}>
        ...
        {error && (
          <div style={{ background: "rgba(220,38,38,0.1)", border: "1px solid rgba(220,38,38,0.2)", color: "#fca5a5", padding: "14px 20px", borderRadius: 12, marginBottom: 24, fontSize: 13, fontWeight: 600, display: "flex", alignItems: "center", gap: 8, animation: "fadeIn 0.3s ease" }}>
            ...
            <div style={{ background: "rgba(255,255,255,0.03)", border: "1px solid rgba(55,138,221,0.12)", borderRadius: 24, overflow: "hidden" }}>
              ...
              <div style={{ padding: 32 }}>
                <div style={{ textAlign: "center", marginBottom: 24 }}>
                  ...
                  <h2 style={{ fontSize: 19, fontWeight: 600, letterSpacing: "0.05em", marginBottom: 4 }}>
                    {editing ? 'Redigér profil' : user.navn}
                  </h2>
                  <p style={{ fontSize: 10, color: "rgba(232,237,245,0.3)", letterSpacing: "0.2em", textTransform: "uppercase" }}>
                    {editing ? 'Opdater dine oplysninger' : 'Medlem'}
                  </p>
                </div>
                  ...
                  {editing ? (
                    <div style={{ display: "flex", flexDirection: "column", gap: 10 }}>
                      <button className="btn-save" onClick={handleSaveProfile} disabled={saving}>
                        {saving ? (
                          <><div style={{ width: 14, height: 14, border: "2px solid rgba(255,255,255,0.3)", borderTopColor: "#fff", borderRadius: "50%", animation: "spin 0.6s linear infinite" }} /> Gemmer...</>
                        ) : (
                    ...
                    <div style={{ display: "flex", flexDirection: "column", gap: 10 }}>
                      <button className="btn-cancel" onClick={() => setEditing(true)}>
